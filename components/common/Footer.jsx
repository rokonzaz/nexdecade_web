    ...
    <>
      <footer className="footer bg-theme-light/50">
        <div className="container">
          <div className="row gx-5 pb-10 pt-[52px]">
            <div className="col-12 mt-12 md:col-6 lg:col-3">
              ...
              <p className="mt-6">
                Nexdecade Technology Pvt. Ltd is a leading technology service specially Vehicle Tracking Solutions
                Provider in Bangladesh
              </p>
            </div>
            <div className="col-12 mt-12 md:col-6 lg:col-3">
              <h6>Socials</h6>
              <p>info@nexdecade.com</p>
            ...
            <div className="col-12 mt-12 md:col-6 lg:col-3 space-y-2 ">
        ...
        <div className="container max-w-[1440px]">
          ...
          >
            <p className="mt-6 text-center text-primary text-xs">
              © 2024 Nexdecade, All Rights
              Reserved.
            </p>
          </div>
        </div>
